...
// .env in the current working directory - that breaks the moment this is launched as
// "node server/index.js" from the project root instead of from inside server/ itself).
